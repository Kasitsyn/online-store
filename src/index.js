...
export const renderFilters = (filters, e) => {
    ...
    tags.forEach((tag) => {
        filters.has(tag.innerText.toLowerCase())
            ? tag.classList.add('filter__btn--active')
            : tag.classList.remove('filter__btn--active');
    });
};
...
export const getSearchResults = (dataFromStore) => {
    ...
    const searchResult = dataFromStore.filter((article) =>
...
export const yearRangeSlider = createAndRenderRangeSlider(
    'range-slider-year',
    'input-year-0',
    'input-year-1',
    1990,
    2022,
    store.rangeFilters.year
);
export const rateRangeSlider = createAndRenderRangeSlider(
    'range-slider-rating',
    'input-rating-0',
    'input-rating-1',
    0,
    10,
    store.rangeFilters.rating
);
